...
[表单示例代码](http://localhost/examples/ui/formview/formview.html) 展示了一组良好布局的表单组件，全部标题居左且右对齐。
其代码设置如下：
...
* *完整的示例代码，请访问 [FormView示例](http://localhost/examples/ui/formview/formview.html)*
...
## 更多组件示例
请访问[JSFX示例](http://localhost/examples/jsfx/)