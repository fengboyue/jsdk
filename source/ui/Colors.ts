...
module JS {
    ...
    export namespace ui {
        ...
        export class Colors {
             ...
             * @param hex 
             */
            public static hex2rgba(hex: HEX): RGBA {
                if(!hex) return null;
             ...
             */
            public static rgba2css(c: RGBA): RGBAString {
                if(!c) return ''; 
             ...
             */
            public static hsla2string(c: HSLA): HSLAString {
                if(!c) return ''; 
             ...
             */
            public static rgbTohsl(rgb: RGBA): HSLA {
                if(!rgb) return null; 
            ...
            public static css2rgba(css: string): RGBA{
                if(!css) return null; 
