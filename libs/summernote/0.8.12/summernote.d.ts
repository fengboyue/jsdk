...
type toolbarViewGroupOptions = 'fullscreen' | 'codeview' | 'undo' | 'redo';
...
interface JQuery {
    ...
    summernote(command: 'code', markupStr?: string): JQuery|string;
    ...
    // Callbacks 
    // todo!
    // supplement by Jie Zhou
    on(eventName: string, callback: (...args: any[]) => void):any;

    on(eventName: "summernote.init", callback:(e: Event) => any):JQuery;
    on(eventName: "summernote.enter", callback:(e: Event) => any):JQuery;
    on(eventName: "summernote.focus", callback:(e: Event) => any):JQuery;
    on(eventName: "summernote.blur", callback:(e: Event) => any):JQuery;
    on(eventName: "summernote.keyup", callback:(e: Event) => any):JQuery;
    on(eventName: "summernote.keydown", callback:(e: Event) => any):JQuery;
    on(eventName: "summernote.paste", callback:(e: Event) => any):JQuery;

    on(eventName: "summernote.image.upload", callback:(e: Event, files: FileList) => any):JQuery;
    
    on(eventName: "summernote.change", callback:(e: Event, contents: string, $editable:any) => any):JQuery;
    // what about these?
